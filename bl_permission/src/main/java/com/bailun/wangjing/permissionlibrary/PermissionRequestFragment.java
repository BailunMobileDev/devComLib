...
public class PermissionRequestFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        BLPermissionUtils.requestPermissions(new FragmentPermissionObjectWrap(this), permissionList, requestCode);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        int result = BLPermissionUtils.getStateOnRequestPermissionsResult(grantResults, new FragmentPermissionObjectWrap(this), permissions);
